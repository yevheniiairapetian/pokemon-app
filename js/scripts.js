...
for(i = 0; i < pokemonList.length; i++){
    document.write('<div class="pokemon-items">' + '<p>' + 'Pokemon\'s Name: '+ pokemonList[i].name + '</p>' + '<p>' + 'Height:' + pokemonList[i].height + 'm'+ '</p>' + '<p>' + 'Abilities:' + pokemonList[i].abilities + '</p>' + '<p>' + 'Weight:' + pokemonList[i].weight + 'kg' + '</p>' + '<p>' + 'Catch Rate:' + pokemonList[i].catchRate + '</p>' + '<p>' + 'Egg Groups:' + pokemonList[i].eggGroups + '</p>' + '<p>' + 'Gender Ratio:' + '<br>' + '<p class="additional-info">' + 'Male - ' + '</p>' + pokemonList[i].genderRatio.male + '<p class="additional-info"> ' + 'Female - ' + '</p>' + pokemonList[i].genderRatio.female + '<p>' + 'Hatch Steps:' + pokemonList[i].hatchSteps + '</p>' + '</div>');
